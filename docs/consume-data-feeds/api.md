...
- **Curl Example:**
  ```bash
  curl -X GET 'https://api-staging.razorscan.io/collections'
...
- **Curl Example:**
  ```bash
  curl -X GET 'https://api-staging.razorscan.io/collection/{nameHash}'
...
- **Curl Example:**
  ```bash
  curl -X GET 'https://api-staging.razorscan.io/col/{id}'
